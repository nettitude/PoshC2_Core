...
namespace Core
{
    internal class Core
    {
        ...
        [CoreDispatch(Description = "Used for checking a specific process on a remote host using WMI", Usage = "Usage: get-remoteprocesslisting HOSTNAME1,HOSTNAME2 [explorer.exe] [Username] [Domain] [Password]")]
